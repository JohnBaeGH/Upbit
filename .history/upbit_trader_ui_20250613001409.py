    ...
    def update_market_display(self, tickers_data):
        ...
        try:
            ...
            for row, ticker in enumerate(tickers_data):
                ...
                # 색상 설정
                price_color_str = get_price_color(change_price)
                price_color = QColor(price_color_str)
